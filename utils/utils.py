...
def parse_args():
    ...
    parser.add_argument('--unseen_test_set', default=True, action='store_true',
    ...
    parser.add_argument('--ae_hidden_units', type=int, default=1000,
                        help='number of autoencoder hidden units')
    parser.add_argument('--embedding_units', type=int, default=1000,
                        help='number of hidden units')
    ...
    parser.add_argument('--name', type=str, default='mmfit_trained_' + str("{:%Y%m%dT%H%M}".format(datetime.datetime.now())),
                        help='name of experiment')
    parser.add_argument('--output', type=str, default='output/',
                        help='path to output folder')
    parser.add_argument('--trained_model', type=str, default=None,
                        help='trained model name')
    parser.add_argument('--split_sample', type=int, default=1,
                        help='split training se with every n-th frame image')
