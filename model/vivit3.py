...
class ViViT(nn.Module):
    ...
    def __init__(self, t, h, w, patch_t, patch_h, patch_w, num_classes, dim, depth, heads, mlp_dim, dim_head=3, channels=3, mode='tubelet', emb_dropout=0., dropout=0., model=3):
        super().__init__()
...
if __name__ == '__main__':
    x = torch.rand(32, 3, 32, 64, 64).cuda()

    vivit = ViViT(32, 64, 64, 8, 4, 4, 10, 512, 6, 10, 8, model=3).cuda()
    out = vivit(x)
    print(out)